...
FIELD_ALIASES: dict[str, tuple[str, ...]] = {
    "invoice": ("ma_hoa_don", "so_chung_tu", "so_chung_tu_ban_hang"),
    "date": (
        "thoi_gian",
        "ngay_hach_toan",
        "ngay_chung_tu",
    ...
    "supplier_code": ("ma_nha_cung_cap", "ma_ncc", "nha_cung_cap", "ma_ncc_noi_bo"),
    "supplier_name": ("ten_nha_cung_cap", "ten_ncc", "ten_ncc_day_du"),
    "item_code": ("ma_hang", "ma_dich_vu", "ma_sku_ban", "ma_sku_mua"),
    "item_name": ("ten_hang", "ten_dich_vu"),
    "unit": ("dvt", "don_vi_tinh"),
    "quantity": ("so_luong", "sl_ban", "sl_nhap"),
    "unit_price": ("don_gia", "gia_ban", "gia_mua"),
    "line_amount": ("thanh_tien",),
    "discount_percent": ("giam_gia_percent", "ty_le_ck_percent"),
    "discount_amount": ("giam_gia", "tien_chiet_khau", "column1"),
    ...
    "vat_rate": ("percent_vat", "vat_percent", "thue_suat", "thue_suat_gtgt", "percent_thue_gtgt"),
    "vat_amount": ("tien_thue", "tien_thue_gtgt", "vat"),
    "other_charges": ("thu_khac",),
    "payable": ("khach_can_tra", "tong_thanh_toan", "tong_tien_thanh_toan"),
    "lot": ("lo", "so_lo"),
    "expiry_date": ("han_su_dung",),
    "payment_method": ("phuong_thuc_thanh_toan", "pt_thanh_toan", "hinh_thuc_thanh_toan"),
    "debit_account": (
        "tk_tien_chi_phi_no",
        "tk_no",
        "tai_khoan_no",
    ...
    "input_vat_account": ("tk_thue_mua", "tk_thue_gtgt_dau_vao", "tk_vat_dau_vao"),
    "inventory_account": (
        "tk_kho_tk_chi_phi",
        "tk_kho_chi_phi",
        "tk_kho",
    ...
    "item_type": ("loai_hang", "loai_hhdv", "hang_hoa_dich_vu"),
}
