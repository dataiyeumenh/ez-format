...
def aggregate_document_totals(
    ...
    *,
    ...
    """Aggregate detail amounts once and repeated document totals once per key."""
    ...
    if "conflicting_document_total" in issues or "invalid_line_amount" in issues or "invalid_document_total" in issues:
        status = "blocked"
