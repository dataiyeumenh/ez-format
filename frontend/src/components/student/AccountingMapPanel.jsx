                  ...
                  >
                    ...
                    {evidence.source_rows?.[0] && (
                      <button
                        ...
                        onClick={() =>
                          onEvidenceNavigate?.({
                            id: `${map.voucher_id}-${index}`,
                            row: evidence.source_rows[0],
                            field: evidence.target_field,
                            target_field: evidence.target_field,
                          })
                        }
                        className="mt-3 text-xs font-black text-primary-700 underline"
                      >
                        Mở dòng nguồn {evidence.source_rows[0]}
                      </button>
                    )}
                  </div>
                );
